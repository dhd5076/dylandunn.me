          ...
          <Jumbotron className="text-white mt-4 p-0 dark-color mb-0">
            <Row className="m-0 p-0">
              <Col xs={12} md={6} className="m-0 p-0">
                    <ListGroup>
                        <ListGroup.Item href="/picture/create" action className="text-white d-flex justify-content-between col-12 align-items-center">
                            <span>
              ...
              <Col className="col-md-6 col-xs-12 light-color text-dark">
                  ...
                  <p className="lead">Website Control Console</p>
              </Col>
            </Row>
          </Jumbotron>
      </>
