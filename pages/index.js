  ...
  return (
    <>
      <div className="sm:flex">
        ...
        <div className="text-white font-bold text-3xl bg-black/75 flex-auto sm:w-2/3">
          ...
          <div className="flex p-6">
            ...
            <Link className="text-lg hover:brightness-75 bg-white text-black/75 p-4 border-r-2 border-black/25" href="https://www.patreon.com/DylanDunn">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="main-grid-item-icon" fill="none">
            ...
            <Link className="text-lg bg-white hover:brightness-75 text-black/75 p-4" href="https://youtube.com/@Dylan_Dunn">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="main-grid-item-icon" fill="none">
      ...
      <div className="p-0 flex-grow5">
        ...
        <div className="sm:flex p-0 m-0 bg-white/25">
      ...
      <div className="text-black bg-white/75 w-full sm:w-auto p-6 flex">
